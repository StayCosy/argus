...
-- ----------------------------
-- Table structure for BUSI_UNIQUE_CTRL
-- ----------------------------
DROP TABLE IF EXISTS `BUSI_UNIQUE_CTRL`;
CREATE TABLE `BUSI_UNIQUE_CTRL`  (
  ...
  UNIQUE INDEX `UQ_BUSI_UNIQUE_CTRL_1`(`PART_ID`, `BUSI_SEQ_NO`) USING BTREE
